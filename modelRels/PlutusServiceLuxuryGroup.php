<?php
namespace app\modelRels;
use app\core\ModelRel;
use app\core\Record;

class PlutusServiceLuxuryGroup extends ModelRel
{
    public function __construct($params = [])
    {
        $params["dbName"] = "plutus";
        $params["dataName"] = "ServiceLuxuryGroup";

        parent::__construct($params);
    }
}

class PlutusServiceLuxuryGroupRecord extends Record
{
