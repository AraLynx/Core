...
//require_once dirname(__DIR__,3)."/Chronos/functions/encrypt.php";//UNTUK generateUniqueId
//$datas["post"] = $_POST;
$ajax = new Ajax("crud"/*, $ManualPageId, $ManualPOSId */);
//$datas["ajax_post"] = $ajax->getPost();
//$BranchId = $ajax->$ajax->getPost("loginBranchId") * 1;//akan post["loginBranchId"] akan hilang setelah validate

//FORM VALIDATION
//$ajax->isCbpPicker("post");//khusus untuk form dengan cbpPicker
...
if($app->getStatusCode() == 100)
{
    ...
    //JTUniqueId = generateUniqueId($ajax->getPost("loginUserId"));
    /*
    DO OTHER STUFF HERE
    */
}
