...
<html lang="en">
    ...
    <body class="d-none">
        <main class="container">
            <div class="h3 mt-4">Hi <?php echo $User->Name;?>,</div>
            <div class="mt-3">
                We're sorry to hear that you're having trouble with logging in to <?php echo $ajax->get["a"];?>.
                <br/>But worry not, you have <span class="text-primary fw-bold">successfully</span> reset your <span class="text-danger fw-bold">login password</span>.
                <br/><br/>For security reason, we are sending the new password back to <span class="text-primary fw-bold">your email</span>.
                <br/>Please check you inbox / spam box.
                <br/><br/><span class="text-danger fw-bold">If you haven't receive the new password for the next 10 minutes, please contact <a href="mailto: it.helpdesk@trimandirigroup.com">IT Help Desk.</a></span>
            </div>
