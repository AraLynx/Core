...
class UranusEmployee extends ModelFact
{
    /*
    ...
    */
    public function __construct(array $params = [])
    {
        ...
        $params["dataName"] = "Employee";

        parent::__construct($params);

        $this->setChild("\app\modelFacts\UranusUser");
        $this->setChild("\app\modelFacts\UranusEmployeeStatus");
    }
}

class UranusEmployeeRecord extends Record
{
