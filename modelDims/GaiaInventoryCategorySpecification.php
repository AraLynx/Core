...
class GaiaInventoryCategorySpecification extends ModelDim
{
    public function __construct($params = NULL)
    {
        $params["dbName"] = "Gaia";
        $params["dataName"] = "InventoryCategorySpecification";

        parent::__construct($params);
    }
}

class GaiaInventoryCategorySpecificationRecord extends Record
{
