...
class UranusEmployeeStatusAdditional extends ModelDim
{
    public function __construct(array $params = [])
    {
        $params["dbName"] = "uranus";
        $params["dataName"] = "EmployeeStatusAdditional";

        parent::__construct($params);
    }
}

class UranusEmployeeStatusAdditionalRecord extends Record
{
