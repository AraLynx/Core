...
<div id='reportDiv_<?php echo $reportId;?>' class='reportDiv d-none'>
    ...
    $gridParams = array(
        ...
        "columns" => array(
            ...
            array("title" => "BIAYA REAL", "columns" => [
                ["field" => "CostAksesoris", "title" => "Aksesoris", "formatType" => "currency"],
                ["field" => "CostBBNUnNotice", "title" => "Un Notice", "formatType" => "currency"],
                ["field" => "CostFeeCabang", "title" => "Fee Cabang", "formatType" => "currency"],
                ["field" => "CostInsentif", "title" => "Insentif", "formatType" => "currency"],
                ["field" => "CostPDI", "title" => "PDI", "formatType" => "currency"],
                ["field" => "CostMediator", "title" => "Mediator", "formatType" => "currency"],
                ["field" => "CostOngkirMainDealer", "title" => "Ongkir MD", "formatType" => "currency"],
                ["field" => "CostOngkirKonsumen", "title" => "Ongkir Konsumen", "formatType" => "currency"],
                ["field" => "CostOngkirLain", "title" => "Ongkir Lain", "formatType" => "currency"],
                ["field" => "CostBungaDO", "title" => "Bunga DO", "formatType" => "currency"],
                ["field" => "CostDeco", "title" => "Perbaikan", "formatType" => "currency"],
                ["field" => "CostTotal", "title" => "Total", "formatType" => "currency"],
            ]),

            array("title" => "OTHER INCOME", "columns" => [
                ["field" => "DiffTotal", "title" => "Total", "formatType" => "currency"],
            ]),
            array("field" => "GPAfterDiff", "title" => "GP + Other Income", "formatType" => "currency"),
