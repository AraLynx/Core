...
<footer id="footer" class="footer sticky-bottom">
    <div id="footer_news" class="opacity-0 bg-light">
        <div class="container-xxl">
            <div id="footer_news_notif" class="py-1 text-dark"></div>
        </div>
    </div>
    <div id="footer_copyright" class="bg-<?php echo strtolower(APP_NAME);?> text-white">
        <div class="container-xxl">
