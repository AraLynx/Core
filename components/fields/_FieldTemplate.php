...
class _FieldTemplate extends Field
{
    ...
    public function __construct(array $params)
    {
        ...
        /*Field Properties*/
        $this->elementTag = "input";/* Nama element, DEFAULT INPUT */
        $this->jsClassName = "TDEFieldText";/* Nama class javascript, DEFAULT TDEFieldText */
        ...
        $this->inputType = "text";/* attribute tipe untuk element input */
