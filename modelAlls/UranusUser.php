...
class UranusUser extends ModelAll
{
    public function __construct($params = NULL)
    {
        $params["dbName"] = "uranus";
        $params["dataName"] = "User";

        parent::__construct($params);
    }
}

class UranusUserRecord extends Record
{
...
#region data process
    ...
    protected function generateNameProfile(array $params = [])
    {
        ...
        $FaIconGender = "";
        $nameProfiles[] = "<span class='fw-bold'>{$this->Username}</span> (UID {$this->Id})";
        ...
        if($this->Username)$nameProfiles[] = "{$FaIconGender}<span class='text-muted fst-italic'>{$this->Name} (NIP {$this->EmployeeId})</span>";
        ...
        $this->nameProfile = implode($glue, $nameProfiles);
    }
