    ...
    #region setting variable
        public function begin()
        {
            ...
            if(!$this->isSubForm)
            {
                ...
                $this->jsFormReset = "TDE.{$this->elementId}.reset = function(){";
        ...
        public function end()
        {
            ...
            if(!$this->isSubForm)
            {
                ...
                //$this->jsFormReset .= "$('#{$this->elementId}').trigger('reset');";
                $this->jsFormReset .= "};";

                $this->globalJS .= $this->jsFormReset;
    ...
    #region data process
        ...
        #region dynamic form
            public function addDynamicForm(string $dynamicForm)
            {
                ...
                //$inputElementId = $this->generateInputId("DynamicForm", "BLANK", "");
        ...
        #region field generator
            public function addField(array $params)
            {
                ...
                $inputGroup = $params["inputGroup"] ?? ["BLANK"];
                ...
                else if($inputType == "kendoMaskedTextBox")
                {
                    ...
                    if($mask == "rt")$inputStyle .= ";width:50px";
                    if($mask == "rw")$inputStyle .= ";width:50px";
                    if($mask == "npwp")$inputStyle .= ";width:140px";
                    if($mask == "pkp")$inputStyle .= ";width:140px";
                    if($mask == "ktp")$inputStyle .= ";width:140px";
                }
                                    ...
                                    foreach($inputGroup AS $index => $groupName)
                                    {
                                        ...
                                        $html .= "<div style='width:calc(100%/{$inputGroupCount});'>";
                                            if($inputType == "text" || $inputType == "email" || $inputType == "password")
                                            {
                                                ...
                                                $this->jsFormReset .= "TDE.{$inputElementId}.reset();";
                                            }
                                            ...
                                            else if($inputType == "textarea")
                                            {
                                                ...
                                                if($textareaShowCounter)
                                                {
                                                    ...
                                                    $this->jsFormReset .= "TDE.{$inputElementId}.updateCounter();";
                                                }
                                            ...
                                            else if($inputType == "kendoDatePicker_range")
                                            {
                                                ...
                                                /*
                                                $js .= "TDE.{$inputElementIdStart}.reset = function(){

                                                };";
                                                $js .= "TDE.{$inputElementIdEnd}.reset = function(){

                                                };";

                                                $this->jsFormReset .= "TDE.{$inputElementIdStart}.reset();";
                                                $this->jsFormReset .= "TDE.{$inputElementIdEnd}.reset();";
                                                */
                                            }
                                            else if($inputType == "kendoMaskedTextBox")
                                            {
                                            ...
                                            else if(in_array($inputType,["kendoDropDownList","kendoComboBox","kendoMultiSelect","kendoDropDownTree"]))
                                            {
                                                $elementType = "select";
                                                ...
                                                else if($selectTypeDetail == "cbpPicker")
                                                {
                                                    ...
                                                    foreach($selectTemplates AS $index => $selectTemplate)
                                                    {
                                                        ...
                                                        if(count($columnKeys))//ADA SELECT BOX SEBELUMNYA, BUAT OBJECT OPSI SELECT BERDASARKAN KEY SEBELUMNYA
                                                        {
                                                            ...
                                                            //if($selectTemplate == "Company")dd($ListOfDatas);
                                                        }
                                                ...
                                                else
                                                {
                                                    ...
                                                    if(count($selectOptions))
                                                    {
                                                        $this->jsFormReset .= "TDE.{$inputElementId}.populate(".json_encode($selectOptions).");";
                                                    }
                                                }
                                                ...
                                                $js .= "TDE.{$inputElementId} = $('#{$inputElementId}').{$inputType}({
                                                        ...
                                                        */
                                                        $js .="select: function(e){
                                                                /*console.log('Select');console.log(e);*/";
                                                                if($uploadOnSelectFunction)$js .= "{$uploadOnSelectFunction}(e);";
                                                        $js .="},
                                                            upload: function(e){
                                                                /*console.log('Cancel');console.log(e);*/";
                                                                if($uploadOnUploadFunction)$js .= "{$uploadOnUploadFunction}(e);";
                                                        $js .="},
                                                            progress: function(e){
                                                                /*console.log('Progress :: ' + e.percentComplete+ '%');console.log(e);*/";
                                                        ...
                                                        $js .="},
                                                            success: function(e){
                                                                /*console.log('Success (' + e.operation + ')');console.log(e);*/
                                                                /*console.log(e.response);console.log(e.files);*/";
                                                        ...
                                                        $js .="},
                                                            error: function(e){
                                                                alert('Error (' + e.operation + ')');/*console.log(e);*/";
